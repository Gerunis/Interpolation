...
namespace Interpolation
{
    class Program
    {
        ...
        static public void CountLagrangePolynomial(Dot[] dots)
        {
            ...
            Console.WriteLine("Лагранж: f(x)= {0:0.0000;-0.0000} * x^2 {1:+ 0.0000;- 0.0000} * x {2:+ 0.0000;- 0.0000}", res[0], res[1], res[2]);
        }
        ...
        static public void CountNutonPolynomial(Dot[] dots)
        {
            ...
            res[2] = deltas[2];
            Console.WriteLine("Ньютон: f(x)= {0:0.0000;-0.0000} * x^2 {1:+ 0.0000;- 0.0000} * x {2:+ 0.0000;- 0.0000}", res[2], res[1], res[0]);
        }
